...
class Bill {
    ...
    public int commodityPurchasePrice, commoditySoldPrice, quantity, amount, profit;
    ...
    public Bill(int orderNumber, String userName, String userAddress, String commodityName, String commodityUnit,
        ...
        this.profit = (commoditySoldPrice - commodityPurchasePrice) * quantity;
    }

    @Override
    public String toString() {
        return String.format("%s %s %s %s %d %d %d", code, userName, userAddress, commodityName, quantity, amount,
                profit);
    }
}
